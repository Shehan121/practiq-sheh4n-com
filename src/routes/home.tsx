    ...
    <main className="relative w-full overflow-x-hidden">
      ...
      >
        ...
        <motion.img
          ...
          className="pointer-events-none absolute right-[-6%] top-[20%] z-0 w-[48vw] max-w-[520px] opacity-95 lg:right-[2%] lg:top-[16%] lg:w-[38vw] dark:invert dark:hue-rotate-180"
        />
      ...
      <section id="how" className="relative mx-auto max-w-7xl overflow-hidden px-6 py-28 lg:px-10 lg:py-40">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1fr]">
          <div className="relative">
            <Parallax speed={0.5}>
              <img src={handshake.url} alt="" className="mx-auto w-[90%] max-w-xl lg:w-full dark:invert dark:hue-rotate-180" />
            </Parallax>
      ...
      <section id="applications" className="relative mx-auto max-w-7xl overflow-hidden px-6 py-28 lg:px-10 lg:py-40">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1fr]">
          ...
          <Parallax speed={0.4}>
            <img src={thinking.url} alt="" className="mx-auto w-[90%] max-w-md dark:invert dark:hue-rotate-180" />
          </Parallax>
        </div>
      </section>
      ...
      <section className="relative mx-auto max-w-7xl overflow-hidden px-6 py-28 lg:px-10 lg:py-40">
        ...
        <motion.img
          ...
          src={cat.url}
          alt="Cat"
          className="pointer-events-none absolute right-[-5%] top-[8%] z-0 hidden h-[75vh] w-auto max-w-none opacity-90 lg:block dark:invert dark:hue-rotate-180"
        />
